...
\end{itemize}
\onslide<2->{\textcolor{darkjunglegreen}{\textbf{Security against active adversaries:}}
\begin{itemize}
\item CCA security: Oscar can request decryption of $c'\neq c$ of his choice (Chosen Ciphertext Attack)
\end{itemize}
}
\onslide<3->{\textcolor{red}{No CCA security for homomorphic schemes:}
\begin{itemize}
